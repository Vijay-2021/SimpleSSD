...
#ifndef __ICL_PARTITIONED_DS_CACHE__
#define __ICL_PARTITIONED_DS_CACHE__
...
class PartitionedDSICL : public AbstractICL {
 private:
 ...
 public:
  PartitionedDSICL(icl_params& cparams, FTL::FTL *ftl);
