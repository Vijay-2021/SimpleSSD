...
typedef rv_ret (*csr_read_cb)(void *priv, privilege_level curr_priv_mode, uint16_t address, rv_word_t *out_val);
typedef rv_ret (*csr_write_cb)(void *priv, privilege_level curr_priv_mode, uint16_t address, rv_word_t val);

typedef struct csr_reg_struct {
    uint16_t access_flags;
    rv_word_t value;
    rv_word_t mask;
    rv_word_t warl_always_enabled;
...
static inline rv_word_t csr_get_mask(csr_reg_td *csr_regs, uint16_t address)
{
    return csr_regs[address].mask;
}

void csr_read_reg_internal(csr_reg_td *csr_regs, uint16_t address, rv_word_t *out_val);
void csr_write_reg_internal(csr_reg_td *csr_regs, uint16_t address, rv_word_t val);

rv_ret csr_read_reg(csr_reg_td *csr_regs, privilege_level curr_priv_mode, uint16_t address, rv_word_t *out_val);
rv_ret csr_write_reg(csr_reg_td *csr_regs, privilege_level curr_priv_mode, uint16_t address, rv_word_t val);
