...
#define DEBUG_PRINT(...) do{ } while ( 0 )
    ...
    #define UMULI umul64wide
    #define MULI mul64wide
    ...
    #define UMULI umul32wide
    #define MULI mul32wide
    #define MULHSU mulhsu32wide
#endif

#define GEN_SIGNEX_FUNC(_bit) \
static inline rv_sword_t SIGNEX_BIT_##_bit(rv_sword_t input) \
{ \
    struct {rv_sword_t x:(_bit+1);} s = { .x = input }; \
    return s.x; \
}
