...
#define RAM_SIZE_BYTES 0x80000000UL /* 128MB such as the default for the qemu virt machine */
...
#define STACK_SIZE 0x10000000 /* 16MB stack size per core */
#define CSD_CYCLES_LIMIT 10000 
