...
rv_ret trap_m_write(void *priv, privilege_level curr_priv, uint16_t reg_index, rv_word_t csr_val)
{
    (void)curr_priv;
...
rv_ret trap_m_read(void *priv, privilege_level curr_priv_mode, uint16_t reg_index, rv_word_t *out_val)
{
    (void)curr_priv_mode;
    trap_td *trap = (trap_td *)priv;
...
rv_ret trap_s_write(void *priv, privilege_level curr_priv, uint16_t reg_index, rv_word_t csr_val)
{
    (void)curr_priv;
    trap_td *trap = (trap_td *)priv;
...
rv_ret trap_s_read(void *priv, privilege_level curr_priv_mode, uint16_t reg_index, rv_word_t *out_val)
{
    (void)curr_priv_mode;
    trap_td *trap = (trap_td *)priv;
...
rv_ret trap_u_write(void *priv, privilege_level curr_priv, uint16_t reg_index, rv_word_t csr_val)
{
    (void)curr_priv;
    trap_td *trap = (trap_td *)priv;
...
rv_ret trap_u_read(void *priv, privilege_level curr_priv_mode, uint16_t reg_index, rv_word_t *out_val)
{
    (void)curr_priv_mode;
    trap_td *trap = (trap_td *)priv;
...
trap_ret trap_check_interrupt_pending(trap_td *trap, privilege_level curr_priv_mode, trap_cause_interrupt irq, privilege_level *serving_priv_level )
{
    ...
    *serving_priv_level = machine_mode;
    ...
    for(int delegation_level = machine_mode; delegation_level >= curr_priv_mode; delegation_level--)
    {
        if(delegation_level == reserved_mode)
            continue;

        deleg_register_set = get_priv_regs(trap, (privilege_level)delegation_level);
