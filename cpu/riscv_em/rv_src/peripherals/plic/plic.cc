...
static uint8_t *get_u8_reg_ptr(plic_td *plic, rv_word_t address, uint8_t *is_claim_complete)
{
    uint8_t *ret_ptr = NULL;
    rv_word_t tmp_address = 0;
...
uint64_t plic_bus_access(void *priv, privilege_level priv_level, bus_access_type access_type, rv_word_t address, void *value, uint8_t len)
{
    (void) priv_level;
